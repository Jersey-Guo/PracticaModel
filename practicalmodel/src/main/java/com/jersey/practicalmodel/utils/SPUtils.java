...
public final class SPUtils {
    ...
    public static final String SP_NAME_CHAT = "sp_name_zhiyue_chat";
    public static final String KEY_TOKEN = "token";
    public static final String KEY_USERINFO = "user_info";
    public static final String KEY_USERINFO_FUN = "user_info_fun";
    private static SimpleArrayMap<String, SPUtils> SP_UTILS_MAP = new SimpleArrayMap<>();
    private SharedPreferences sp;



    public static String getFormatKey(String key1, String key2) {
